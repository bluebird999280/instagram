	...
	return (
		<div className="relative flex-auto flex flex-row h-9 border gap-2 border-[#dbdbdb] ml-[40px] mr-[40px] mb-[6px] ">
			<input
				...
				onChange={onChange}
				className="top-0 left-0 bg-neutral-50 flex-[1_0_0px] pt-[14px] pb-[2px] pl-[8px] border-0 outline-none overflow-hidden ellipsis text-[12px]"
			/>
			<div
				className={
			...
			<div className="h-full flex items-center mr-1">
				<div
					className={
						"w-[22px] h-[22px] bg-[url('/src/assets/images/icons/TJztmXpWTmS.png')] " +
			...
			<div
				className="h-full text-[14px] text-[#262626] cursor-pointer font-bold flex items-center mr-1"
